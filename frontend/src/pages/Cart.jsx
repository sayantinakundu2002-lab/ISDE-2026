...
function Cart({ cart, onRemoveFromCart, onCheckout, loading }) {
  return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col w-full text-center sm:text-left">
                    ...
                    <div className="mt-auto flex items-center justify-between">
                      <div className="inline-flex items-center bg-white border border-slate-200 rounded-full px-4 py-1.5 shadow-sm text-sm font-bold text-slate-900">
                        Qty: {item.quantity}
                      </div>
                      <button
