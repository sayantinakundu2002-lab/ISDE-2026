        ...
        <div className="p-8 md:p-12 md:w-2/3 border-b md:border-b-0 md:border-r border-slate-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input type="text" name="name" value={form.name} onChange={handleChange} className={inputClass} placeholder="e.g. Ergonomic Office Chair Pro" />
            </div>
            ...
            <div>
              ...
              <input type="url" name="image_url" value={form.image_url} onChange={handleChange} className={inputClass} placeholder="https://..." />
            </div>
